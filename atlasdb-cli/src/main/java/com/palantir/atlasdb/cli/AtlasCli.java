...
import com.palantir.atlasdb.cli.command.SnapshotCommand;
...
public class AtlasCli {
    ...
    private static Cli<Callable> buildCli() {
        Cli.CliBuilder<Callable> builder = Cli.<Callable>builder("atlas-cli")
                ...
                .withCommands(Help.class, TimestampCommand.class, CleanTransactionRange.class, SnapshotCommand.class);
